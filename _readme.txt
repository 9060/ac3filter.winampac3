...
WinampAC3 is high quality freeware AC3 and DTS decoder for Winamp.
This application is a part of AC3Filter project (http://ac3filter.net).

Main features:
* Decode AC3/DTS
* AC3/DTS SPDIF passthrough support
* AC3 encode to output multichannel data to SPDIF
* Detailed input bitstream format information
* Automatic Gain Control
* Dynamic Range Compression
* Online output configuraion change
* Upmix to 3-6 channels
...
WinampAC3 project has dependency on the valib library project so 
by default directories should be configured as follows:

...\winampac3     - winampac3 project
...\valib         - valib project
...
mailto:xvalex@mail.ru?Subject=WinampAC3

Please write in English or Russian. Subject should have 'WinampAC3' word 
